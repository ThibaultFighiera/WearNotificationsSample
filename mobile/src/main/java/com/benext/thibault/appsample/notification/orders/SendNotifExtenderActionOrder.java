 ...
 */
public class SendNotifExtenderActionOrder implements Order {
    @Override
    public void execute(Context context) {
        NotificationCompat.Builder builder = NotificationBuilder.buildNotificationExtenderAction(context);
        NotificationBuilder.sendNotification(context, builder);
    }

    @Override
    public int getName() {
        return R.string.notif_extender_action_name;
    }
}
