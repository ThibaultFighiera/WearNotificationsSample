...
public class SendNotifExtenderOrder implements Order {
    @Override
    public void execute(Context context) {
        NotificationCompat.Builder builder = NotificationBuilder.buildNotificationExtender(context);
        NotificationBuilder.sendNotification(context, builder);
    }

    @Override
    public int getName() {
        return R.string.notif_extender_name;
    }
}
